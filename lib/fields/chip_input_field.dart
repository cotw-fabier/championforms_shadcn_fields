...
class ChipInputField extends form.Field {
  ...
  ChipInputField copyWith({
    ...
    List<form.FieldOption>? suggestions,
    String? placeholder,
    ...
    ValueChanged<List<form.FieldOption>>? onChipsChanged,
    ...
    return ChipInputField(
      ...
      useChips: useChips ?? this.useChips,
      autoInsertSuggestion: autoInsertSuggestion ?? this.autoInsertSuggestion,
      ...
      children: [
        shadcn.AutoComplete(
          ...
          child: shadcn.ChipInput<String>(
            ...
            // Fall back to the core requestFocus flag so both field families
            // honor it; an explicit autofocus still wins.
